\thispagestyle{empty}
%\subsection{ANEXO A. Manual de Uso e Instalación}\label{anexoA}
...
vista Exhaustiva, los margenes utilizados en la evaluación del estado y un
mensaje con las características del motor o
