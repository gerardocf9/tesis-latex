...
(autentificación, administración, etc.), seguridad (previene errores comunes
...
matemáticas, generación de números aleatorios, rutinas algebraicas de algebra
lineal, transformadas de fourier, el tratado de arreglos N-dimensionales,
vectorizacion e indexación de los mismos, todo esto a un gran rendimiento y una
...
\subsubsection{Digital ocean y Heroku}
