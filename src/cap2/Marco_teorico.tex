...
\begin{itemize}
    ...
    \item Acelerómetros piezoeléctricos:
        ...
        Según \cite{WeberPiezoelectricAT}, es el acelerómetro más usado en
...
que permiten comunicarse con servidores que realizan la mayor parte del trabajo.
 Permitiendo el desarrollo de aplicaciones complejas que funcionen desde la
...
Las bases de datos, según \cite{bbddTipos} se suelen dividir en dos tipos, de
...
Según \cite{Hosting} un ``Hosting"\ es el servicio que permite que un sitio
Web o dominio permanezca en internet, permite guardar la información de un sitio
y acceder a este, además en este espacio permite acceder a  APIs o servidores.
...
explica en su sitio oficial \cite{DigitalOcean} se dedica a alquilar servicios
de computo en la nube los cuales son robustos y escalables, además de contener
una muy buena documentación. DigitalOcean permite el agregar APIs además de
