...
\pagenumbering{roman}
    ...
    \includepdf{material_auxiliar/actaAprobacion.pdf}
    \newpage
...
%***************************************************
    ...
    \include{src/cap4/Lenguajes_Herramientas_Utilizados}%1 por objetivo
    % LENGUAJES Y HERRAMIENTAS UTILIZADOS
    \include{src/cap4/Modelo_Estadistico}
    % MODELO ESTADISTICO DE LA VIBRACION
    \include{src/cap4/Analisis_Frecuencia}
    % ANALISIS EN FRECUENCIA
    \include{src/cap4/Servidores_BBDD}
    % SERVIDORES, CONEXION CON SENSORES, BASES DE DATOS,
    \include{src/cap4/Clientes}
    \include{src/cap4/Resultados}
    % UI, CLIENTE WEoB
    \begin{figure}[H]
        \centering
...
%**********  Capitulo 5  ***************************
%***************************************************
    \include{src/cap5/ConclusionesRecomendaciones}
...
\titleformat{\section}
%{\small}{}{3pt}{ANEXO \thesection. \filcenter \LARGE}
{\normalfont\bfseries\Large}{\filcenter ANEXO \thesection.}{1em}{}
